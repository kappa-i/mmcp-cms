...
export interface ApiCurrentlyCurrently extends Struct.CollectionTypeSchema {
  collectionName: 'currentlies';
  info: {
    displayName: 'Currently';
    pluralName: 'currentlies';
    singularName: 'currently';
  };
  options: {
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    scrollingSign: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::currently.currently': ApiCurrentlyCurrently;
